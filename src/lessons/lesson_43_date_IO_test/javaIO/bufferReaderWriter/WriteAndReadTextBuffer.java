package lessons.lesson_43_date_IO_test.javaIO.bufferReaderWriter;
...
public class WriteAndReadTextBuffer {
    public static void main(String[] args) throws IOException {
        ...
        String path = "basic_programming/lesson_43_date_IO_test/resource/writeExample.txt";
    ...
    public void readerBufferFile(String path) throws IOException {
        ...
        BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter("basic_programming/lesson_43_date_IO_test/resource/writeExample2.txt"));
