...
public class DequeueExample {
    public static void main(String[] args) {
        ...
        System.out.println("DequeuePalindrome после добавления элементов: " + integerDeque);
        ...
        System.out.println("DequeuePalindrome после удаления элементов: " + integerDeque);
